  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }}>
      ...
      <Box sx={{ mb: 8, textAlign: 'center' }}>
        ...
        <Box sx={{ bgcolor: 'primary.light', p: 4, borderRadius: 2, mb: 4 }}>
      ...
      {/* Values Section */}
      <Box sx={{ mb: 8, bgcolor: 'primary.light', p: 4, borderRadius: 2 }}>
        <Typography variant="h3" component="h2" sx={{ color: 'primary.main', mb: 4, textAlign: 'center' }}>
          OUR VALUES
        </Typography>
        <Typography variant="h6" sx={{ textAlign: 'center', mb: 4, color: 'primary.dark' }}>
