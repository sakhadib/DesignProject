...
//       return "Invalid time"; // Return a default string for invalid dates
//     }
...
const fetchUpcomingContests = async () => {
    ...
    try {
        const response = await axios.post("/contest/future/my");
...
const fetchPreviousContests = async () => {
    ...
    try {
        const response = await axios.post("/contest/history");
            ...
            <TableBody>
              {contests.length > 0 ? (
                ...
                sx={{
                  ...
                  <TableCell sx={{textAlign: "center"}}>{contests.contests.id}</TableCell>
                  <TableCell sx={{textAlign: "center"}}>{contests.contests.title}</TableCell>
                  <TableCell sx={{textAlign: "center"}}>{formatLocalTime(contests.contests.start_time)}</TableCell>
                  <TableCell sx={{textAlign: "center"}}>
                  {Math.round((new Date(contest.end_time) - new Date(contests.contests.start_time)) / 60000)} minutes
                  </TableCell>
                  <TableCell sx={{textAlign: "center"}}>{contests.contests.user.username}</TableCell>
                  <TableCell sx={{textAlign: "center"}}>{contests.contests.participants_count}</TableCell>
