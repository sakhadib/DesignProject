...
//         {/* Conditionally render Sign In/Sign Up or Profile/Sign Out */}
//         {!isAuthenticated ? (
//           <>
//             <ListItem component="div">
//               <Button color="primary" variant="text" fullWidth component={Link} to="/signin">
...
//           <>
//             <ListItem component="div">
//               <Button color="primary" variant="text" fullWidth component={Link} to="/profile">
//                 Profile
//               </Button>
//             </ListItem>
//             <ListItem component="div">
...
//           ) : (
//             <>
//               <Button color="primary" variant="text" className="text-sm font-medium" component={Link} to="/profile">
//                 Profile
//               </Button>
//               <Button
//                 variant="contained"
