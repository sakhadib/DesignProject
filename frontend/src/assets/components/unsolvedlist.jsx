    ...
    const fetchProblems = async () => {
        try {
            const response = await axios.get("/problem/my/unsolved"); // Updated API endpoint
            setProblems(response.data.problems || []); // Adjust to match the API response format
        } catch (error) {
      ...
      <Box sx={{ mb: 2 }}>
        ...
        <Paper sx={{ width: "100%", mb: 2 }}>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="all problems table">
                <TableHead>
                <TableRow sx={{justifyContent:"center", alignItems:"center", textAlign:"center"}}>
                    ...
                    <TableHeader label="Submissions" property="total_submissions" />
                    <TableHeader label="Max XP" property="recieved_max_xp" />
                </TableRow>
                </TableHead>
                <TableBody>
                {filteredAndSortedProblems
                    ...
                    >
                        ...
                        <TableCell sx={{textAlign:"center"}}>{problem.total_submissions}</TableCell>
                        <TableCell sx={{textAlign:"center"}}>{problem.recieved_max_xp}</TableCell>
                    </TableRow>
                    ))}
                </TableBody>
            </Table>
